...
GUILD_ID = 1500709291101917266

# ─── Role IDs ──────────────────────────────────────────────────────────────────
ROLE = {
    "middleman":      1500709291508633706,
    "senior_mid":     1500709291508633707,
    "mid_manager":    1500709291508633708,
    "moderator":      1500709291521212462,
    "head_mod":       1500709291521212464,
    "lead_coord":     1500709291529736343,
    "admin":          1500709291529736346,
    "head_admin":     1500709291529736347,
    "co_founder":     1500709291529736349,
    "ops_manager":    1500709291529736350,
    "chief_exec":     1500709291546644620,
    "director":       1500709291546644622,
    "president":      1500709291546644624,
    "head_staff":     1500709291546644626,
}
...
class AppView(discord.ui.View):
    ...
    async def apply(self, interaction: discord.Interaction, btn: discord.ui.Button):
        ...
        await ch.send(content="<@&1500709291529736346>", embed=embed, view=CloseOnlyView())
        await interaction.response.send_message(f"Ticket created: {ch.mention}", ephemeral=True)
...
HITTER_ROLE_ID = 1500709291508633702
    ...
    async def accept(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        dm_embed.add_field(
            ...
            value=(
                ...
                "and create a ticket in [#mm-request](https://discord.com/channels/1437134165106622486/1500709292645548186). "
