...
class AppView(discord.ui.View):
    ...
    async def apply(self, interaction: discord.Interaction, btn: discord.ui.Button):
        ...
        await ch.send(content="<@&1499791069334863872>", embed=embed, view=CloseOnlyView())
        await interaction.response.send_message(f"Ticket created: {ch.mention}", ephemeral=True)
...
HITTER_ROLE_ID = 1499791093644919014
    ...
    async def accept(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        dm_embed.add_field(
            ...
            value=(
                ...
                "and create a ticket in [#mm-request](https://discord.com/channels/1437134165106622486/1499791053828522034). "
...
WELCOME_CHANNEL_ID = 1499791272259359011
